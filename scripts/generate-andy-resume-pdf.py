...
def create_resume():
    ...
    story.append(Paragraph(
        "Partner in the litigation section of Mills Shirley LLP. Represents clients in commercial, construction, maritime, insurance defense, and civil disputes. Practice includes both trial and appellate work, with a particular focus on construction, design, and commercial litigation. Based in Galveston, advising a range of businesses, owners, and insurers.",
        styles['ResumeBody']
    ))
